...
def run_week1(log) -> dict:
    ...
    log("\n[Director -> Systems Engineer] spec/ui_spec.md handed over (row 8 — UI "
        ...
        "T-UI-04 are in-editor Unreal Automation, marked † in §4.11, and what they lack "
        "is the real Stratocracy widgets they assert over — the editor pass they also "
        "lacked landed at UE fed8ae9 — so the ledger row does not flip and the runner "
        "names both by name.")
    ...
    log("\n[Director -> Systems Engineer] spec/replay_spec.md handed over (row 10 part "
        ...
        "§4.11 and asserted jointly with T-INT-02, so it closes in the editor pass and "
        "nowhere headless — which it since did, at UE 0897cb5, together with T-INT-02. "
        "§4.11 put closure in part (c) because week 2's log carried only "
