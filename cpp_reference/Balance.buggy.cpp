// PASS-1 VARIANT. Generated from Balance.good.cpp by tmp/r10c_mkbuggy.py — three mechanical edits, each the pass-1 reading of a decision Balance.h states in prose. Not shippable code.
...
bool aiCommandToSave(const GameState& g, const AiCommand& a, int turn, int side,
    ...
    case AiCommandKind::Attack: {
        const GameUnit* target = findGameUnit(g, a.unitId);
    ...
    case AiCommandKind::Build:
        ...
        out.unitId  = a.unitId;        // Build names the unit BUILT (Save.h)
        out.hex     = a.hex;
        out.hasUnit = true;
        out.hasHex  = true;
        return true;
